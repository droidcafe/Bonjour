...
public class Events {
   ...
   DatabaseCreater edatabaseCreater;
    ...
    class Asyncinsert extends AsyncTask<Void,Void,Integer>
    {
        ...
        int[] intvalues;
        SQLiteDatabase db;
        Calendar tempcalendar3,fromcalendar;
        Asyncinsert(String[] values, int[] intvalues,SQLiteDatabase db,Calendar fromcalendar,Calendar tempcalendar3)
        {
            this.values = values;
            ...
            this.tempcalendar3 = tempcalendar3;
        }
        ...
        protected Integer doInBackground(Void... params) {
            ...
            int f[] = insertasync(values,intvalues,db,fromcalendar);
    ...
    public void insert(String[] values, int[] intvalues, SQLiteDatabase db,Calendar calendar1,Calendar calendar3)
    {
        Asyncinsert asyncinsert = new Asyncinsert(values,intvalues,db,calendar1,calendar3);
        asyncinsert.execute();
    }


    public int[] insertasync(String[] values,int[] intvalues, SQLiteDatabase db,Calendar fromcalendar)
    {
        int todayinsert =0;
