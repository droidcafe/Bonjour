...
public class TaskNotificationHelper {
    ...
    /**
     * helper function to handle the funtions after a notification has been fired
     * checks if repeat is present for the task. If present it resets data and change
     * done  = 0 else change done =1
     * @param context
     * @param tid
     */
