...
public class Add_Expand extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((EditText) findViewById(R.id.new_task)).setHint(TaskUtil.getRandomHint(this));
            ...
            if (reminder != null) {
                if (reminder[1] == 1) {
                    ...
                    if (time != null) {
                        ...
                        {
                            remmode += 8;
                            repeatselected = LoadTaskHelper.loadRepeat(context,time[4]);
                            Log.d("ae","repeat selected "+repeatselected);
                        }
                    } else {
                        remmode = 1;
                    }
