...
*/
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_clear) {
            ...
            String list;
            if (iswholeday != 1) {
                list = getResources().getString(R.string.eeventform) + fromdatetext + " " + fromtimetext + " "+ getResources().getString(R.string.eto) + todatetext + " " + totimetext;
            } else {
                list = getResources().getString(R.string.ewhole) + fromdatetext;
            }
